        ...
        function campaignWizard() {
            return {
                ...
                form: {
                    name: '{{ old('name') }}',
                    subject: '{{ old('subject') }}',
                    email_list_id: '{{ old('email_list_id') }}',
                    template_id: '{{ old('template_id') }}',
                    track_click: {{ old('track_click') ? 'true' : 'false' }},
                    track_open: {{ old('track_open') ? 'true' : 'false' }},
                    body: `{!! old('body') !!}`,
                ...
                goToStep(s) {
                   // Only allow going back or staying, not jumping forward without validation
                   if (s < this.step) {
                       this.step = s;
                   }
                }
